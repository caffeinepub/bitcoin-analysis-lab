...
export class Backend implements backendInterface {
    ...
    async analyzeAnticipation(): Promise<AnticipationAnalysis> {
        if (this.processError) {
            try {
                const result = await this.actor.analyzeAnticipation();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async analyzeCurrentContext(): Promise<ContextAnalysis> {
        if (this.processError) {
            try {
                const result = await this.actor.analyzeCurrentContext();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getEventStats(): Promise<EventStats> {
        if (this.processError) {
            try {
                const result = await this.actor.getEventStats();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getPriceWindow(arg0: string, arg1: string): Promise<Array<PricePoint>> {
        if (this.processError) {
            try {
                const result = await this.actor.getPriceWindow(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_record_n3(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        title: value.title,
        priceAtEvent: value.priceAtEvent,
        date: value.date,
        priceImpactPercent: value.priceImpactPercent,
...
function from_candid_variant_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "macro" in value ? EventType.macro : "halving" in value ? EventType.halving : "fedEvent" in value ? EventType.fedEvent : "crisis" in value ? EventType.crisis : value;
}
